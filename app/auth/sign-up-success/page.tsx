...
const T = { text: '#1C1917', accent: '#C2410C', muted: 'rgba(28,25,23,0.45)', border: 'rgba(28,25,23,0.08)' }
    ...
    <div style={{ minHeight:'100vh',backgroundColor:'#FAFAF5',fontFamily:"'Montserrat', sans-serif",position:'relative',overflowX:'hidden' }}>
      ...
      <div style={{ position:'relative',zIndex:2,display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',minHeight:'100vh',padding:'24px 16px',paddingLeft:'120px' }}>
        ...
        <div style={{ width:'100%',maxWidth:480,position:'relative' }}>
          ...
          <div style={{ background:'#fff',border:`1px solid ${T.border}`,borderRadius:20,padding:'40px 40px 36px',boxShadow:'0 4px 32px rgba(28,25,23,0.06)',textAlign:'center',position:'relative',overflow:'hidden' }}>
            ...
            <p style={{ fontSize:13,color:T.muted,margin:'0 0 32px',lineHeight:1.6 }}>
              You&apos;ve successfully signed up. Please check your inbox to confirm your account before signing in.
            </p>
            ...
            <p style={{ margin:0,fontSize:12,color:T.muted,letterSpacing:'0.05em' }}>
              Didn&apos;t receive an email?{' '}
              <Link href="/auth/sign-up" style={{ color:T.accent,fontWeight:600,textDecoration:'none' }}>
                Try again
              </Link>
            </p>
          </div>
